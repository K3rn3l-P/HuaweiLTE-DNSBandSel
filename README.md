...
3. ## In home page Copy and paste this script on console [F12] (firefox) 
4. ## Setting Subnet and DNS Selection: recharge page (F5) after go to Advanced > Router > DHCP / Copy and paste this script on console [F12] (firefox)
